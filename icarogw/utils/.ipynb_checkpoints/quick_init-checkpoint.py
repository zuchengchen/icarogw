...
def initialize_prior_dict(population, cosmology, rates, scale_free):
    ...
    if population == 'BBH-powerlaw':
        ...
        prior_dict['α'] = _bilby.core.prior.Uniform(1.5, 5.0, name='$\\alpha$')
    ...
    if cosmology == 'fixed-flatLCDM':
        prior_dict['H0'] = _bilby.core.prior.DeltaFunction(67.74, name='$H_0$')
        prior_dict['Om0'] = _bilby.core.prior.DeltaFunction(0.3065, name='$\Omega_m$')
        ...
        prior_dict['w0'] = _bilby.core.prior.Uniform(-3.0,0., name='$w_0$')
        prior_dict['wa'] = _bilby.core.prior.Uniform(-2.,2., name='$w_a$')

    elif cosmology == 'restricted-flatLCDM':
        prior_dict['H0'] = _bilby.core.prior.Uniform(65.,77., name='$H_0$')
        prior_dict['Om0'] = _bilby.core.prior.DeltaFunction(0.3065, name='$\Omega_m$')
    else:
