...
def initialize_prior_dict2(population, cosmology):
    prior_dict = {}

    if population == 'BBH-mass_powerlaw-z_powerlaw':
        prior_dict['alpha'] = _bilby.core.prior.Uniform(1.5, 12, name='alpha')
        prior_dict['beta'] = _bilby.core.prior.Uniform(-4, 12, name='beta')
        prior_dict['mmin'] = _bilby.core.prior.Uniform(2, 10, name='mmin')
        prior_dict['mmax'] = _bilby.core.prior.Uniform(50, 200, name='mmax')
    ...
    elif population in ["PBH-CC-1st", "PBH-CC-2nd"]:
        prior_dict['α'] = _bilby.core.prior.Uniform(0.0, 5.0, name='$\\alpha$')
        prior_dict['Mf'] = _bilby.core.prior.Uniform(1.0, 50.0, name='$M_f$')
        prior_dict['log_fpbh'] = _bilby.core.prior.Uniform(
            -4.0, 0.0, name='$\\log_{10}\mathrm{fpbh}$')
    ...
    if cosmology == 'fixed-flatLCDM':
        prior_dict['H0'] = _bilby.core.prior.DeltaFunction(67.36, name='$H_0$')
        prior_dict['Om0'] = _bilby.core.prior.DeltaFunction(
            0.315, name='$\Omega_m$')

    elif cosmology == 'flatLCDM':
        prior_dict['H0'] = _bilby.core.prior.Uniform(10, 200, name='$H_0$')
        prior_dict['Om0'] = _bilby.core.prior.Uniform(
            0.0, 1.0, name='$\Omega_m$')

    elif cosmology == 'w0flatLCDM':
        prior_dict['H0'] = _bilby.core.prior.Uniform(10, 200, name='$H_0$')
        prior_dict['Om0'] = _bilby.core.prior.Uniform(
            0.0, 1.0, name='$\Omega_m$')
        prior_dict['w0'] = _bilby.core.prior.Uniform(-3.0, 0.0, name='$w_0$')

    elif cosmology == 'w0waflatLCDM':
        prior_dict['H0'] = _bilby.core.prior.Uniform(10, 200, name='$H_0$')
        prior_dict['Om0'] = _bilby.core.prior.Uniform(
            0.1, 0.5, name='$\Omega_m$')
        prior_dict['w0'] = _bilby.core.prior.Uniform(-3.0, 0.0, name='$w_0$')
        prior_dict['wa'] = _bilby.core.prior.Uniform(-2.0, 2.0, name='$w_a$')

    elif cosmology == 'restricted-flatLCDM':
        prior_dict['H0'] = _bilby.core.prior.Uniform(
            65.0,   77.0, name='$H_0$')
        prior_dict['Om0'] = _bilby.core.prior.DeltaFunction(
            0.315, name='$\Omega_m$')
    else:
...
def initialize_prior_dict(population, cosmology, rates, scale_free):
    ...
    if rates == 'non-evolving':
        ...
        prior_dict['gamma'] = _bilby.core.prior.Uniform(0, 12, name='gamma')
        prior_dict['kappa'] = _bilby.core.prior.Uniform(0, 6, name='kappa')
        prior_dict['zp'] = _bilby.core.prior.Uniform(0, 4, name='zp')
    elif rates == 'PBH':
        pass
    else:
    ...
    if population == 'BBH-powerlaw':
        ...
        prior_dict['sigma_g'] = _bilby.core.prior.Uniform(
            0.4, 10, name='sigma_g')
        prior_dict['lambda_peak'] = _bilby.core.prior.Uniform(
            0, 1, name='lambda_peak')
        prior_dict['delta_m'] = _bilby.core.prior.Uniform(
            0, 10, name='delta_m')
        ...
        prior_dict['sigma_g'] = _bilby.core.prior.DeltaFunction(
            5, name='sigma_g')
        prior_dict['lambda_peak'] = _bilby.core.prior.DeltaFunction(
            0.5, name='lambda_peak')
        prior_dict['delta_m'] = _bilby.core.prior.DeltaFunction(
            2, name='delta_m')

    elif population == 'BBH-broken-powerlaw':
        prior_dict['alpha_1'] = _bilby.core.prior.Uniform(
            1.5, 12, name='alpha_1')
        prior_dict['alpha_2'] = _bilby.core.prior.Uniform(
            1.5, 12, name='alpha_2')
        prior_dict['beta'] = _bilby.core.prior.Uniform(-4, 12, name='beta')
        prior_dict['mmin'] = _bilby.core.prior.Uniform(2, 50, name='mmin')
        prior_dict['mmax'] = _bilby.core.prior.Uniform(50, 200, name='mmax')
        ...
        prior_dict['alpha_1'] = _bilby.core.prior.DeltaFunction(
            2, name='alpha_1')
        prior_dict['alpha_2'] = _bilby.core.prior.DeltaFunction(
            1, name='alpha_2')
        prior_dict['beta'] = _bilby.core.prior.DeltaFunction(0, name='beta')
        prior_dict['mmin'] = _bilby.core.prior.DeltaFunction(5, name='mmin')
        prior_dict['mmax'] = _bilby.core.prior.DeltaFunction(50, name='mmax')
        ...
        prior_dict['mmin'] = _bilby.core.prior.Uniform(2, 10, name='mmin')
        prior_dict['mmax'] = _bilby.core.prior.Uniform(30, 100, name='mmax')
        prior_dict['mu_g_low'] = _bilby.core.prior.Uniform(
            20, 50, name='mu_g_low')
        prior_dict['sigma_g_low'] = _bilby.core.prior.Uniform(
            0.4, 10, name='sigma_g_low')
        prior_dict['mu_g_high'] = _bilby.core.prior.Uniform(
            50, 100, name='mu_g_high')
        prior_dict['sigma_g_high'] = _bilby.core.prior.Uniform(
            0.4, 10, name='sigma_g_high')
        prior_dict['lambda_g'] = _bilby.core.prior.Uniform(
            0, 1, name='lambda_g')
        prior_dict['lambda_g_low'] = _bilby.core.prior.Uniform(
            0, 1, name='lambda_g_low')
        prior_dict['delta_m'] = _bilby.core.prior.Uniform(
            0, 10, name='delta_m')
        ...
        prior_dict['σc'] = _bilby.core.prior.Uniform(
            0.1, 2, name='$\\sigma_c$')
        prior_dict['m_min'] = _bilby.core.prior.Uniform(
            3.0, 10.0, name='$m_{min}$')
        prior_dict['m_max'] = _bilby.core.prior.Uniform(
            60.0, 200.0, name='$m_{max}$')

    elif population == 'PBH-lognormal-nocut':
        prior_dict['mc'] = _bilby.core.prior.Uniform(5.0, 50.0, name='$M_c$')
        prior_dict['σc'] = _bilby.core.prior.Uniform(
            0.1, 2, name='$\\sigma_c$')

    elif population == 'PBH-powerlaw':
        prior_dict['α'] = _bilby.core.prior.Uniform(0.0, 2.0, name='$\\alpha$')
        prior_dict['m_min'] = _bilby.core.prior.Uniform(
            3.0, 10.0, name='$m_{min}$')
        prior_dict['m_max'] = _bilby.core.prior.Uniform(
            60.0, 200.0, name='$m_{max}$')

    elif population == 'PBH-powerlaw-nocut':
        prior_dict['α'] = _bilby.core.prior.Uniform(
            1.001, 2.0, name='$\\alpha$')
        prior_dict['m_min'] = _bilby.core.prior.Uniform(
            3.0, 10.0, name='$m_{min}$')
...
def initialize_events_dict(runs, type=None, snr_cut=None, ifar_cut=None, to_include=None):
    ...
    events_dict = {'GW150914': {'SNR': 24.4, 'ifar': 1/1.0e-7, 'RUN': 'O1', 'TYPE': 'BBH', 'IFOS': 'HL'},
                   ...
                   # Set threshold of 1/2yr according to GWTC2.1, SNR from GWTC-2
                   'GW190424_180648': {'T_NAME': 'S190424ao', 'SNR': 10.0, 'ifar': 1/2, 'RUN': 'O3a', 'TYPE': 'BBH', 'IFOS': 'L', 'PE_NAME': 'GW190424A'},
                   'GW190425': {'T_NAME': 'S190425z', 'SNR': 12.86, 'ifar': 2.957851e+01, 'RUN': 'O3a', 'TYPE': 'BNS', 'IFOS': 'LV', 'PE_NAME': 'GW190425A'},
                   # Compatible with NSB but high FAR, taken from Tab. III of GWTC-2.1
                   'GW190426_152155': {'T_NAME': '-', 'SNR': 10.1, 'ifar': 1/0.91, 'RUN': 'O3a', 'TYPE': 'NSBH', 'IFOS': 'HLV', 'PE_NAME': 'GW190426A'},
                   # New massive event in GWTC2.1
                   'GW190426_190642': {'T_NAME': 'S190426c', 'SNR': 9.57, 'ifar': 2.450886e-01, 'RUN': 'O3a', 'TYPE': 'BBH', 'IFOS': 'HL', 'PE_NAME': 'GW190426B'},
                   ...
                   # Classified as special because very massive
                   ...
                   # New troublesome event, possibly NSBH from GWTC2.1, taken from GWTC-3
                   'GW190531_023648': {'T_NAME': '-', 'SNR': 10.0, 'ifar': 1/0.41, 'RUN': 'O3a', 'TYPE': 'NSBH', 'IFOS': 'HLV', 'PE_NAME': 'GW190531A'},
                   ...
                   # One of the new events has some prob in pastro NSBH
                   'GW190725_174728': {'T_NAME': 'S190725t', 'SNR': 9.84, 'ifar': 2.182329e+00, 'RUN': 'O3a', 'TYPE': 'BBH', 'IFOS': 'HLV', 'PE_NAME': 'GW190725A'},
                   ...
                   # Recovered even with smaller SNR in GWTC2.1, deranked, TAB IV
                   'GW190909_114149': {'T_NAME': 'S190909w', 'SNR': 8.5, 'ifar': 1/1.1, 'RUN': 'O3a', 'TYPE': 'SPECIAL', 'IFOS': 'HL', 'PE_NAME': 'GW190909A'},
                   ...
                   # New event from GWTC2.1, a BBH
                   'GW190916_200658': {'T_NAME': '-', 'SNR': 8.22, 'ifar': 2.106446e-01, 'RUN': 'O3a', 'TYPE': 'BBH', 'IFOS': 'HLV', 'PE_NAME': 'GW190916A'},
                   # New event in GWTC2.1, a possible NSBH like GW190814
                   'GW190917_114630': {'T_NAME': 'S190917u', 'SNR': 9.46, 'ifar': 1.523161e+00, 'RUN': 'O3a', 'TYPE': 'NSBH', 'IFOS': 'HLV', 'PE_NAME': 'GW190917A'},
                   'GW190924_021846': {'T_NAME': 'S190924h', 'SNR': 12.96, 'ifar': 1.000000e+05, 'RUN': 'O3a', 'TYPE': 'BBH', 'IFOS': 'HLV', 'PE_NAME': 'GW190924A'},
                   # New event from GWTC2.1, a BBH
                   'GW190925_232845': {'T_NAME': 'S190925ad', 'SNR': 9.88, 'ifar': 1.387649e+02, 'RUN': 'O3a', 'TYPE': 'BBH', 'IFOS': 'HV', 'PE_NAME': 'GW190925A'},
                   # New event from GWTC2.1, a BBH
                   'GW190926_050336': {'T_NAME': '-', 'SNR': 9.00, 'ifar': 8.707174e-01, 'RUN': 'O3a', 'TYPE': 'BBH', 'IFOS': 'HLV', 'PE_NAME': 'GW190926A'},
