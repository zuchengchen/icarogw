...
class hierarchical_analysis():
    ...
    def run_bilby(self, mass_model, cosmo_model, rate_model, prior_dict, parallel=10000,**kwargs):
        ...
        **kwargs: Bilby kwargs to run the sampler.
        ...
        likeli = BBH_likelihood(self.pos_samples_dict, self.injections, mass_model=mass_model, cosmo_model=cosmo_model, rate_model=rate_model, parallel=parallel, scale_free=self.scale_free)
